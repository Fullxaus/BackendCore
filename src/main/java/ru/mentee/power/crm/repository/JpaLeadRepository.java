...
public class JpaLeadRepository implements LeadDomainRepository {
    ...
    try {
      return jpaRepository
          ...
          .map(
              entity -> {
                log.debug(
                    "Found LeadEntity: id={}, email={}, company={}",
                    entity.getId(),
                    entity.getEmail(),
  ...
  public Lead findByIdForUpdate(UUID id) {
    ...
    return jpaRepository.findByIdForUpdate(id).map(this::toModel).orElse(null);
  }
  ...
  private Lead toModel(LeadEntity e) {
    try {
      ...
      log.debug(
          "Converting LeadEntity to Lead: id={}, email={}, phone={}, company={}, status={}",
          e.getId(),
          e.getEmail(),
          e.getPhone(),
          e.getCompanyName(),
      ...
      try {
        ...
        log.error(
            "Failed to create Address: city={}, street={}, zip={}, error={}",
            city,
            street,
            zip,
            ex.getMessage());
      ...
      String email =
          (e.getEmail() != null && !e.getEmail().isEmpty()) ? e.getEmail() : "unknown@example.com";
      ...
      try {
        ...
        log.error(
            "Failed to create Contact: email={}, phone={}, error={}",
            email,
            phone,
            ex.getMessage());
        throw ex;
      ...
      String company =
          (e.getCompanyName() != null && !e.getCompanyName().isEmpty())
              ? e.getCompanyName()
              : "Unknown";
      String statusRaw =
          (e.getStatus() != null && !e.getStatus().isEmpty()) ? e.getStatus() : "NEW";
      ...
      try {
        ...
        log.error(
            "Failed to create Lead: id={}, company={}, status={}, error={}",
            e.getId(),
            company,
            status,
            ex.getMessage());
      ...
      log.error(
          "IllegalArgumentException while converting LeadEntity to Lead: {}", ex.getMessage(), ex);
      log.error(
          "LeadEntity details: id={}, email={}, phone={}, company={}, status={}, city={}, street={}, zip={}",
          e != null ? e.getId() : "null",
