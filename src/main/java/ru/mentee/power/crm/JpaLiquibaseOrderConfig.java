...
/**
 * Гарантирует, что Liquibase выполнится до создания EntityManagerFactory, чтобы миграции создали
 * таблицы (companies, leads и т.д.) до валидации схемы Hibernate.
 */
@Component
