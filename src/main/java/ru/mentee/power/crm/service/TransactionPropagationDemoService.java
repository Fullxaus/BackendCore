...
/**
 * Демонстрация параметров propagation и isolation для @Transactional. Используется в тестах для
 * изучения поведения REQUIRED, REQUIRES_NEW, MANDATORY и уровней изоляции.
 */
@Service
