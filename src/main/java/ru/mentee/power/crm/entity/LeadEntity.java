...
public class LeadEntity {
  ...
  /**
   * Связь с компанией по id — одна и та же компания (Сбербанк / Sberbank) идентифицируется по
   * company_id.
   */
  ...
  /**
   * Устанавливает связь с компанией и синхронизирует денормализованное имя (колонка company NOT
   * NULL).
   */
