...
/**
 * Demo controller showing all three types of Dependency Injection for comparison. - Constructor
 * Injection: immutable, testable without Spring - Field Injection: not testable without Spring,
 * mutable - Setter Injection: mutable, testable but less explicit
 */
@RestController
public class DemoController {
  ...
  @Autowired private FieldDemoService fieldService;
