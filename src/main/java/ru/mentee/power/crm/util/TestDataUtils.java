...
/**
 * Утилита для генерации тестовых данных лидов. Создаёт набор лидов с различными компаниями и
 * статусами.
 */
public class TestDataUtils {
  ...
  private static final List<String> COMPANIES =
      List.of("ABC Company", "XYZ Corporation", "Acme Technologies", "Pro Services", "InnoCorp");
  private static final List<String> PHONES =
      List.of("+79001234567", "+79112345678", "+79223456789");
  private static final List<String> ADDRESS_CITIES =
      List.of("Москва", "Санкт-Петербург", "Новосибирск", "Екатеринбург", "Казань");
  private static final List<String> ADDRESS_STREETS =
      List.of("улица Ленина", "Проспект Мира", "Тверская улица", "Невский проспект");
