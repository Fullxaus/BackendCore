...
public class LeadRepositoryTest {
  ...
  void shouldSaveAndFindLeadById_whenLeadSaved() {
    ...
    Contact contact =
        new Contact("ivan@mail.ru", "+79001234567", new Address("улица", "дом", "10001"));
  ...
  void shouldReturnAllLeads_whenMultipleLeadsSaved() {
    ...
    Contact contact1 =
        new Contact("ivan@mail.ru", "+79001234567", new Address("Boston", "Smith", "111"));
    Contact contact2 =
        new Contact("ivan@mail.ru", "+79001234567", new Address("London", "QueenStreet", "001100"));
