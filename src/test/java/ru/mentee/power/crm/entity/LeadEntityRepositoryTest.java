...
public class LeadEntityRepositoryTest {
  ...
  void shouldFindByStatus() {
    ...
    assertThat(newLeads).extracting(LeadEntity::getStatus).containsOnly("NEW");
  }
  ...
  void shouldFindByCompany() {
    ...
    assertThat(acmeLeads).extracting(LeadEntity::getCompanyName).containsOnly("Acme Corp");
  }
  ...
  void shouldFindByStatusAndCompany() {
    ...
    // Then
    assertThat(results).hasSize(2);
    assertThat(results).extracting(LeadEntity::getStatus).containsOnly("NEW");
    assertThat(results).extracting(LeadEntity::getCompanyName).containsOnly("Acme Corp");
  }
  ...
  void shouldFindByStatusIn() {
    ...
    assertThat(results).hasSize(3);
    assertThat(results)
        .extracting(LeadEntity::getStatus)
  ...
  void shouldFindByStatusInPaged() {
    ...
    Page<LeadEntity> page =
        repository.findByStatusInPaged(Arrays.asList("NEW", "CONTACTED"), pageable);
