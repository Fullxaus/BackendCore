...
public class DataInitializerTest {
  ...
  void setUp() {
    ...
    dataInitializer =
        new DataInitializer(
            leadService,
            coreLeadRepository,
            mock(ru.mentee.power.crm.spring.service.DealService.class),
            dealRepository,
            leadStatusService);
  }
  ...
  void run_shouldAddFiveLeads() throws Exception {
    ...
    verify(leadService, times(5))
        .addLead(anyString(), anyString(), any(LeadStatus.class), any(Address.class), anyString());
