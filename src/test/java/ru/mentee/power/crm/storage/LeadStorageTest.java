...
public class LeadStorageTest {
  ...
  void shouldAddLead_whenLeadIsUnique() {
    ...
    Contact contact =
        new Contact("ivan@mail.ru", "+7123", new Address("New York", "456 Broadway", "10001"));
  ...
  void shouldRejectDuplicate_whenEmailAlreadyExists() {
    ...
    Contact anotherContact =
        new Contact("ivan@mail.ru", "+7456", new Address("Moscow", "789 Street", "20001"));
  ...
  void shouldReturnOnlyAddedLeads_whenFindAllCalled() {
    ...
    Contact contact2 =
        new Contact("maria@startup.io", "+7456", new Address("Moscow", "789 Street", "20001"));
  ...
  void shouldNotAddDuplicateLeads() {
    ...
    for (int index = 0; index < 100; index++) {
      Contact contact =
          new Contact(
              "lead" + index + "@mail.ru",
              "+7000",
              new Address("New York", "456 Broadway", "10001"));
    ...
    Contact contact =
        new Contact("lead0@mail.ru", "+7001", new Address("New York", "456 Broadway", "10001"));
